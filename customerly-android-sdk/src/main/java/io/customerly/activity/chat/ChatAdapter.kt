 ...
 */
internal class ChatAdapter(chatActivity : ClyChatActivity) : RecyclerView.Adapter<ChatViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ChatViewHolder {
        ...
        return when (viewType) {
            R.layout.io_customerly__li_bubble_account_typing -> ChatViewHolder.Typing(recyclerView = recyclerView)
            R.layout.io_customerly__li_bubble_user -> ChatViewHolder.Message.User(recyclerView = recyclerView)
            R.layout.io_customerly__li_bubble_account -> ChatViewHolder.Message.Account(recyclerView = recyclerView)
            else/* R.layout.io_customerly__li_message_account_rich */ -> ChatViewHolder.Message.AccountRich(recyclerView = recyclerView)
        }
    }
    ...
    override fun onViewDetachedFromWindow(holder: ChatViewHolder) { holder.clearAnimation() }
}