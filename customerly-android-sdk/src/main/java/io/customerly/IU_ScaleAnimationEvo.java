...
class IU_ScaleAnimationEvo {

    static void startScaleIn(@NonNull View view, long duration) {
        IU_ScaleAnimationEvo.start(view, duration, null, null, null, 0, 1, 0, 1, Animation.RELATIVE_TO_SELF, 0.5f, Animation.RELATIVE_TO_SELF, 0.5f);
    }

    static void startScaleIn(@NonNull View view, long duration, @Nullable Runnable onAnimationEnd) {
        IU_ScaleAnimationEvo.start(view, duration, null, null, onAnimationEnd, 0, 1, 0, 1, Animation.RELATIVE_TO_SELF, 0.5f, Animation.RELATIVE_TO_SELF, 0.5f);
    }
    ...
    static void startScaleIn(@NonNull View view, long duration, @Nullable Runnable onAnimationStart, @Nullable Runnable onAnimationRepeat, @Nullable Runnable onAnimationEnd) {
        IU_ScaleAnimationEvo.start(view, duration, onAnimationStart, onAnimationRepeat, onAnimationEnd, 0, 1, 0, 1, Animation.RELATIVE_TO_SELF, 0.5f, Animation.RELATIVE_TO_SELF, 0.5f);
    }

    static void startScaleIn(@NonNull View view, long duration, float pivotXValue, float pivotYValue) {
        IU_ScaleAnimationEvo.start(view, duration, null, null, null, 0, 1, 0, 1, Animation.RELATIVE_TO_SELF, pivotXValue, Animation.RELATIVE_TO_SELF, pivotYValue);
    }
    ...
    static void startScaleIn(@NonNull View view, long duration, @Nullable Runnable onAnimationEnd, float pivotXValue, float pivotYValue) {
        IU_ScaleAnimationEvo.start(view, duration, null, null, onAnimationEnd, 0, 1, 0, 1, Animation.RELATIVE_TO_SELF, pivotXValue, Animation.RELATIVE_TO_SELF, pivotYValue);
    }

    static void startScaleOut(@NonNull View view, long duration) {
        IU_ScaleAnimationEvo.start(view, duration, null, null, null, 1, 0, 1, 0, Animation.RELATIVE_TO_SELF, 0.5f, Animation.RELATIVE_TO_SELF, 0.5f);
    }

    static void startScaleOut(@NonNull View view, long duration, @Nullable Runnable onAnimationEnd) {
        IU_ScaleAnimationEvo.start(view, duration, null, null, onAnimationEnd, 1, 0, 1, 0, Animation.RELATIVE_TO_SELF, 0.5f, Animation.RELATIVE_TO_SELF, 0.5f);
    }
    ...
    static void startScaleOut(@NonNull View view, long duration, @Nullable Runnable onAnimationStart, @Nullable Runnable onAnimationRepeat, @Nullable Runnable onAnimationEnd) {
        IU_ScaleAnimationEvo.start(view, duration, onAnimationStart, onAnimationRepeat, onAnimationEnd, 1, 0, 1, 0, Animation.RELATIVE_TO_SELF, 0.5f, Animation.RELATIVE_TO_SELF, 0.5f);
    }

    static void startScaleOut(@NonNull View view, long duration, float pivotXValue, float pivotYValue) {
        IU_ScaleAnimationEvo.start(view, duration, null, null, null, 1, 0, 1, 0, Animation.RELATIVE_TO_SELF, pivotXValue, Animation.RELATIVE_TO_SELF, pivotYValue);
    }
    ...
    static void startScaleOut(@NonNull View view, long duration, @Nullable Runnable onAnimationEnd, float pivotXValue, float pivotYValue) {
        IU_ScaleAnimationEvo.start(view, duration, null, null, onAnimationEnd, 1, 0, 1, 0, Animation.RELATIVE_TO_SELF, pivotXValue, Animation.RELATIVE_TO_SELF, pivotYValue);
    }
    ...
    static void start(@NonNull View view, long duration, float fromX, float toX, float fromY, float toY, int pivotXType, float pivotXValue, int pivotYType, float pivotYValue) {
        IU_ScaleAnimationEvo.start(view, duration, null, null, null, fromX, toX, fromY, toY, pivotXType, pivotXValue, pivotYType, pivotYValue);
    }

    static void start(@NonNull View view, long duration, float fromX, float toX, float fromY, float toY) {
        IU_ScaleAnimationEvo.start(view, duration, null, null, null, fromX, toX, fromY, toY, Animation.RELATIVE_TO_SELF, 0.5f, Animation.RELATIVE_TO_SELF, 0.5f);
    }
    ...
    static void start(@NonNull View view, long duration, @Nullable Runnable onAnimationEnd, float fromX, float toX, float fromY, float toY) {
        IU_ScaleAnimationEvo.start(view, duration, null, null, onAnimationEnd, fromX, toX, fromY, toY, Animation.RELATIVE_TO_SELF, 0.5f, Animation.RELATIVE_TO_SELF, 0.5f);
    }
    ...
    static void start(@NonNull View view, long duration, @Nullable Runnable onAnimationStart, @Nullable Runnable onAnimationRepeat, @Nullable Runnable onAnimationEnd, float fromX, float toX, float fromY, float toY) {
        IU_ScaleAnimationEvo.start(view, duration, onAnimationStart, onAnimationRepeat, onAnimationEnd, fromX, toX, fromY, toY, Animation.RELATIVE_TO_SELF, 0.5f, Animation.RELATIVE_TO_SELF, 0.5f);
    }
    ...
    static void start(@NonNull View view, long duration, @Nullable Runnable onAnimationEnd, float fromX, float toX, float fromY, float toY, int pivotXType, float pivotXValue, int pivotYType, float pivotYValue) {
        IU_ScaleAnimationEvo.start(view, duration, null, null, onAnimationEnd, fromX, toX, fromY, toY, pivotXType, pivotXValue, pivotYType, pivotYValue);
    }
